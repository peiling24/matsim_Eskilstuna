...
public class CreateBicycleNetworkWithElevation {
    ...
    private static final String outputCRS = "EPSG:3006"; //UTM-32
    private static final String inputOsmFile = "Eskilstuna/eskilstuna.osm.pbf";
    private static final String inputTiffFile = "Eskilstuna/DEM.tiff"; 
    private static final String outputFile = "Eskilstuna/dem_network.xml.gz";
